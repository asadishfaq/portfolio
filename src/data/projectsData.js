...
export const projectsData = [
  {
    id: 1,
    projectName: "Haywood Traders",
    projectDesc:
      "Haywood offers a complete white Label infrastructure used by start-up and established online brokers, proprietary trading firms, and hedge funds. Our white label solutions are affordable, and quick to launch your own-branding trading platform business.Made for start-up firms seeking a high-performance and affordable solution, that supports multi assets (Stocks, Futures, Forex, Crypto) multiple brokers, and trading destinations",
    tags: ["React", "HTML", "CSS", "Javascript"],
    // code: "https://github.com/sreerag-rajan/historythroughmovies",
    demo: "https://haywoodtrader.com/",
    image:
